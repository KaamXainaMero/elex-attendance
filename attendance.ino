...
byte Name1[4]={'70','1D','0B','55'};//first UID card
byte Name2[4]={'29','C5','55','0F'};//second UID card
...
void setup() {
  ...
  Serial.println("LABEL,Date,Time,Name,Roll_Number");// make four columns (Date,Time,[Name:"user name"]line 48 & 52,[Roll Number:"roll number"]line 49 & 53)
